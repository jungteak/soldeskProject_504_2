		...
		<div id="qnaboard">
			<c:forEach items="${list}" var="list">
				<div class="qnabdList" title="${list.qnabd_no}">
					<div class="q" title="${list.qnabd_no}"><strong>Q? </strong><span>${list.qnabd_q}</span>
					...
					<div class="a"><strong>A : </strong><span>${list.qnabd_a}</span><hr></div>
				</div>
			</c:forEach>
		</div>
