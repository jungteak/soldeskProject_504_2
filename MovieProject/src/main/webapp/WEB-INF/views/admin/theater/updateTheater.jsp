	...
	<div id="container">
		<div id="body">
			...
			<input type="hidden" name="_method" value="put">
				<table>
					<tr>
						<td class="item">상영관 번호</td><td colspan="3"><input id="th_no" name="th_no" value="${dto.th_no}" class="text"></td>
					</tr>
					<tr>
						<td class="item">상영관 열</td>
						<td><select name="th_col"  class="select">
						<c:forEach begin="1" end="9" var="i">
							<option value="${i}" <c:if test="${dto.th_col==i}">selected</c:if>>${i}</option>
						</c:forEach>
						</select></td>
						<td class="item">상영관 행</td>
						<td><select name=th_row class="select">
						<c:forEach begin="1" end="9" var="i">
					...
					<tr>
						<td colspan="4"><div align="center"><input type="submit" value="수정"></div></td>
					</tr>
				</table>
